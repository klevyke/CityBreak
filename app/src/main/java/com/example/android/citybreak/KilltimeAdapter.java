...
/**
 * Created by Levy on 13.04.2018.
 */

public class KilltimeAdapter extends ArrayAdapter<Killtime> {
    /**
     ...
     */
    public KilltimeAdapter(@NonNull Context context, ArrayList<Killtime> restaurant) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Killtime currentRestaurant = getItem(position);
